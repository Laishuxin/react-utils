...
export default function Counter3() {
  ...
  return (
    <div>
      <h1>Counter3</h1>
      <span>please input step: </span><input type="number" onChange={e => setInputValue(e.target.value)} value={inputValue}/>
      <p>当前计数为：{value}</p>
      <div className="btns">
        ...
        <button onClick={() => dispatch(action3_create(RESET, inputValue))}>reset</button>
      </div>
    </div>
  )
}
